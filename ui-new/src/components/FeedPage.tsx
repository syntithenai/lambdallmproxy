    ...
    >
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4">
          ...
          {/* How downvoting works - Info banner */}
          <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-800">
                <strong>How Feed Personalization Works:</strong> Upvote (Save) content to see more on those topics. 
                Downvote (Block) to hide topics from future feeds. Your preferences help curate better content over time. 
                Manage blocked topics in Settings → Feed tab.
              </div>
            </div>
          </div>
